...
BOOLS = {"matchup_tips": True,    # generate the AI lane tip in champ-select/in-game
         ...
         "ward_clock": True,      # widget: WARD CLOCK — objective vision deadlines, jg/sup (core/lolward)
...
MAX_ELO_ON = ("auto_accept", "auto_ban", "auto_import", "auto_mute",
              ...
              "bleed_guard", "closer", "gold_clock", "ward_clock",
              "respawn_plan", "death_brief", "loading_scout",
              "queue_call",
